...
namespace BetterSL.Patches.Scp939
{
    ...
    public class Scp939ClawMaxHitsPatch
    {
        public static bool Prefix(ScpAttackAbilityBase<Scp939Role> __instance)
        {
            ...
            //        if ((hitboxIdentity == null || targettedPlayers.Remove(hitboxIdentity.TargetHub)) && counter < Plugin.GetConfig().Scp939MaxAoePlayerHits && destructible.Damage(__instance.DamageAmount, damageHandler, destructible.CenterOfMass))
            //        {
